...
//            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile));
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        private void process(CaptureResult result) {
            switch (mCameraState) {
                case STATE_PREVIEW: {
                    // We have nothing to do when the camera preview iTEMPLs working normally.
                    break;
                }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                mPreviewImageReader = ImageReader.newInstance(100, 100, ImageFormat.JPEG,
                        2);
    ...
    private void startBackgroundThread() {
        ...
        mPreviewHandlerThread = new HandlerThread("myImage");
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            mCameraDevice.createCaptureSession(
                    Arrays.asList(surface, mImageReader.getSurface(), mPreviewImageReader.getSurface()),
...
//            captureBuilder.addTarget(mImageReader.getSurface());
     ...
     */
    public static class ConfirmationDialog extends androidx.fragment.app.DialogFragment {
